...
# 
# Usage: http://speakinginbytes.com/2012/10/wordpress-plugin-deployment-script/
#
# @stevengliebe modifications:
# - Rename assets-wp-repo to _wporg-assets
# - Remove automated Git tag/push
# - Modify some wording
...
# @stevengliebe: Prefer to Git tag and push manually:
...
svn delete $SVNPATH/trunk/_wporg-assets
...
svn commit --username=$SVNUSER -m "Uploading version $NEWVERSION1"
